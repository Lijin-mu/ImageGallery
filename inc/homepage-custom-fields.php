...
function ig_banner_section_callback($post) {
    ...
    <div class="ig-custom-fields">
        <p>
            <label for="ig_banner_image"><strong><?php esc_html_e('Image', 'imagegallery'); ?></strong></label><br>
            ...
            <div class="ig-image-upload-wrap" data-target="ig_banner_image" data-preview-size="medium">
                <div class="ig-add-media-wrap"<?php echo $banner_image ? ' style="display:none;"' : ''; ?>>
                    <button type="button" class="button add_media ig-upload-image" data-target="ig_banner_image"><span class="wp-media-buttons-icon"></span><?php esc_html_e('Add Media', 'imagegallery'); ?></button>
                </div>
                <div class="ig-image-preview-wrap" id="ig_banner_image_preview_wrap"<?php echo !$banner_image ? ' style="display:none;"' : ''; ?>>
                    ...
                    <span class="ig-image-actions">
                        <a href="#" class="ig-edit-image dashicons dashicons-edit" data-target="ig_banner_image" title="<?php esc_attr_e('Replace image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Replace image', 'imagegallery'); ?>"></a>
                        <a href="#" class="ig-delete-image dashicons dashicons-trash" data-target="ig_banner_image" title="<?php esc_attr_e('Remove image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Remove image', 'imagegallery'); ?>"></a>
                    </span>
                </div>
            </div>
        </p>
        <p>
            <label for="ig_banner_title"><strong><?php esc_html_e('Title', 'imagegallery'); ?></strong></label><br>
            <input type="text" id="ig_banner_title" name="ig_banner_title" value="<?php echo esc_attr($banner_title); ?>" class="widefat">
        </p>
        <p>
            <label for="ig_banner_bottom_line"><strong><?php esc_html_e('Bottom Line Text', 'imagegallery'); ?></strong></label><br>
            <input type="text" id="ig_banner_bottom_line" name="ig_banner_bottom_line" value="<?php echo esc_attr($banner_bottom_line); ?>" class="widefat">
        </p>
    </div>
    <?php
}
...
function ig_gallery_sections_callback($post) {
    ...
    <div class="ig-custom-fields ig-gallery-repeater">
        <p class="description"><?php esc_html_e('Add multiple gallery sections. Each section can have its own images per row, title, description, and image repeater.', 'imagegallery'); ?></p>
        ...
        <p>
            <button type="button" class="button button-primary" id="ig_add_gallery_section"><?php esc_html_e('Add Gallery Section', 'imagegallery'); ?></button>
        </p>
    </div>
    <?php
}
...
function ig_render_gallery_section_row($idx, $section) {
    ...
    <div class="ig-gallery-section-row" data-index="<?php echo esc_attr($idx); ?>">
        <div class="ig-section-header">
            <h4><?php esc_html_e('Gallery Section', 'imagegallery'); ?> <span class="ig-section-num"></span></h4>
            <button type="button" class="button ig-remove-section"><?php esc_html_e('Remove Section', 'imagegallery'); ?></button>
        </div>
        <div class="ig-section-fields">
            <p>
                <label><strong><?php esc_html_e('Images Per Row', 'imagegallery'); ?></strong></label><br>
            ...
            <p>
                <label><strong><?php esc_html_e('Title', 'imagegallery'); ?></strong></label><br>
                <input type="text" name="ig_gallery_sections[<?php echo esc_attr($idx); ?>][title]" value="<?php echo esc_attr($title); ?>" class="widefat">
            </p>
            <p>
                <label><strong><?php esc_html_e('Short Description', 'imagegallery'); ?></strong></label><br>
                <?php
            ...
            <div class="ig-images-repeater">
                <label><strong><?php esc_html_e('Images (Repeater)', 'imagegallery'); ?></strong></label>
                ...
                <button type="button" class="button ig-add-image" data-section="<?php echo esc_attr($idx); ?>"><?php esc_html_e('Add Image', 'imagegallery'); ?></button>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="ig-image-row" data-img-index="<?php echo esc_attr($img_idx); ?>">
        <div class="ig-image-row-inner">
            <div class="ig-image-upload">
                <input type="hidden" name="ig_gallery_sections[<?php echo esc_attr($section_idx); ?>][images][<?php echo esc_attr($img_idx); ?>][image]" value="<?php echo esc_attr($image_id); ?>" class="ig-image-id">
                <div class="ig-image-upload-inner">
                    <div class="ig-add-media-wrap"<?php echo $image_id ? ' style="display:none;"' : ''; ?>>
                        <button type="button" class="button add_media ig-upload-image-small"><span class="wp-media-buttons-icon"></span><?php esc_html_e('Add Media', 'imagegallery'); ?></button>
                    </div>
                    <div class="ig-image-preview-wrap ig-preview-small"<?php echo !$image_id ? ' style="display:none;"' : ''; ?>>
                        ...
                        <span class="ig-image-actions">
                            <a href="#" class="ig-edit-image-small dashicons dashicons-edit" title="<?php esc_attr_e('Replace image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Replace image', 'imagegallery'); ?>"></a>
                            <a href="#" class="ig-delete-image-small dashicons dashicons-trash" title="<?php esc_attr_e('Remove image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Remove image', 'imagegallery'); ?>"></a>
                        </span>
                    </div>
                </div>
            </div>
            <div class="ig-image-fields">
                <input type="text" name="ig_gallery_sections[<?php echo esc_attr($section_idx); ?>][images][<?php echo esc_attr($img_idx); ?>][title]" value="<?php echo esc_attr($image_title); ?>" placeholder="<?php esc_attr_e('Title', 'imagegallery'); ?>" class="widefat">
                <textarea name="ig_gallery_sections[<?php echo esc_attr($section_idx); ?>][images][<?php echo esc_attr($img_idx); ?>][short_description]" rows="3" placeholder="<?php esc_attr_e('Short description', 'imagegallery'); ?>" class="widefat"><?php echo esc_textarea($image_desc); ?></textarea>
            </div>
...
function ig_about_section_callback($post) {
    ...
    <div class="ig-custom-fields">
        <p>
            <label for="ig_about_title"><strong><?php esc_html_e('Title', 'imagegallery'); ?></strong></label><br>
            <input type="text" id="ig_about_title" name="ig_about_title" value="<?php echo esc_attr($about_title); ?>" class="widefat">
        </p>
        <p>
            <label for="ig_about_description"><strong><?php esc_html_e('Description', 'imagegallery'); ?></strong></label><br>
            <?php
        ...
        <p>
            <label for="ig_about_image"><strong><?php esc_html_e('Image', 'imagegallery'); ?></strong></label><br>
            ...
            <div class="ig-image-upload-wrap" data-target="ig_about_image" data-preview-size="medium">
                <div class="ig-add-media-wrap"<?php echo $about_image ? ' style="display:none;"' : ''; ?>>
                    <button type="button" class="button add_media ig-upload-image" data-target="ig_about_image"><span class="wp-media-buttons-icon"></span><?php esc_html_e('Add Media', 'imagegallery'); ?></button>
                </div>
                <div class="ig-image-preview-wrap" id="ig_about_image_preview_wrap"<?php echo !$about_image ? ' style="display:none;"' : ''; ?>>
                    ...
                    <span class="ig-image-actions">
                        <a href="#" class="ig-edit-image dashicons dashicons-edit" data-target="ig_about_image" title="<?php esc_attr_e('Replace image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Replace image', 'imagegallery'); ?>"></a>
                        <a href="#" class="ig-delete-image dashicons dashicons-trash" data-target="ig_about_image" title="<?php esc_attr_e('Remove image', 'imagegallery'); ?>" aria-label="<?php esc_attr_e('Remove image', 'imagegallery'); ?>"></a>
                    </span>
                </div>
            </div>
        </p>
...
function ig_get_gallery_section_js_template() {
    ...
    <div class="ig-gallery-section-row" data-index="__INDEX__">
        ...
        <div class="ig-section-fields">
            ...
            <p>
                <label><strong><?php esc_html_e('Short Description', 'imagegallery'); ?></strong></label><br>
                <textarea id="ig_gallery_section___INDEX___short_desc" name="ig_gallery_sections[__INDEX__][short_description]" rows="5" class="widefat ig-wp-editor-area"></textarea>
            </p>
            <div class="ig-images-repeater">
                <label><strong><?php esc_html_e('Images (Repeater)', 'imagegallery'); ?></strong></label>
                <div class="ig-images-list">
                    <div class="ig-image-row" data-img-index="0">
                        <div class="ig-image-row-inner">
                            ...
                            <div class="ig-image-fields">
                                <input type="text" name="ig_gallery_sections[__INDEX__][images][0][title]" value="" placeholder="<?php esc_attr_e('Title', 'imagegallery'); ?>" class="widefat">
                                <textarea name="ig_gallery_sections[__INDEX__][images][0][short_description]" rows="3" placeholder="<?php esc_attr_e('Short description', 'imagegallery'); ?>" class="widefat"></textarea>
                            </div>
                            <button type="button" class="button ig-remove-image-row">×</button>
                        </div>
                    </div>
                </div>
                <button type="button" class="button ig-add-image" data-section="__INDEX__"><?php esc_html_e('Add Image', 'imagegallery'); ?></button>
            </div>
        </div>
    </div>
    <?php
